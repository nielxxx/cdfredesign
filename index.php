                    ...
                    <div class="col-lg-6">
                        ...
                        <ul>
                            <li><i class="ri-check-double-line"></i> Our Mission is to help small fisherman and their
                                families in the Philippines to market import quality Cebu Dried Fish and fresh products
                                on Canadian market and beyond.</li>
                            <li><i class="ri-check-double-line"></i> Our Vision is to make a company grow to provide
                                employment to the people in the Philippines</li>
                            <li><i class="ri-check-double-line"></i> Our Goal is to establish market share of at least
                                60% in Alberta and 10% in whole of Canada as suppliaer of dried fish from the
                                Philippines in the next 5 years.</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>
