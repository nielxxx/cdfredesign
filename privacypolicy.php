        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img class="img-fluid animated" id="image-changing" alt="" class="object" data-value="-10">
                </div>
            </div>
        </div>
    </section>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>
                        <h6>This privacy policy ("policy") will help you understand how [name] ("us", "we", "our") uses and 
                        ...
                        <ul>
                            ...
                            <li><i class="ri-check-double-line"></i>Other information such as interests and preferences</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><i class="ri-check-double-line"></i>To contact you to fill out surveys and participate in other types of market research.</li>
                        </ul>
                        <br>
                        ...
                        done all in its power to prevent data theft, unauthorized access, and disclosure by implementing 
                        the latest technologies and software, which help us safeguard all the information we collect online</p>
                        <br>
                    ...
                    <h5>Links to Other Websites</h5>
                        <p>Our website contains links that lead to other websites. If you click on these links, [social media] 
                        is not held responsible for your data and privacy protection. Visiting those websites is not 
                        governed by this privacy policy agreement. Make sure to read the privacy policy documentation 
                    ...
                    <h5>Restricting the Collection of your Personal Data</h5>
                        ...
                        CDF TRADING will not lease, sell or distribute your personal information to any third parties, 
